...
if grep -Eq '^CONFIG_PACKAGE_luci-app-openclash=y' .config; then
    ...
    # core
    wget https://github.com/vernesong/OpenClash/releases/download/Clash/clash-linux-arm64.tar.gz -O - \
    ...
    wget https://github.com/vernesong/OpenClash/releases/download/TUN-Premium/clash-linux-arm64-${TUN_VERSION}.gz \
        -O - | gzip -d - --stdout > ${CLASH_CORE_PATH}/clash_tun
    # game
    wget https://github.com/vernesong/OpenClash/releases/download/TUN/clash-linux-arm64.tar.gz \
